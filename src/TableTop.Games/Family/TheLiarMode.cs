...
public sealed class TheLiarMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [TheLiarCardBank.EverydayCategory] = "#42A5F5",
            [TheLiarCardBank.AdventureCategory] = "#66BB6A",
            [TheLiarCardBank.WorkplaceCategory] = "#FFA726",
            [TheLiarCardBank.RelationshipCategory] = "#EC407A",
            [TheLiarCardBank.DisasterCategory] = "#EF5350",
        };
...
public static class TheLiarCardBank
{
    ...
    internal const string AdventureCategory = "Adventure";
