...
{
    private const string Deck = "Family Stories";
    ...
    private static IReadOnlyList<ICard> Build() =>
        ...
        // ── OPENINGS ─────────────────────────────────────────────────────────
          ...
          "Three rounds of the table to finish it.", Difficulty.Easy)

            .Card("The Wrong House",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"When they arrived at number 47, they immediately knew they had knocked on completely the wrong door.\"</b>", Difficulty.Easy)

            .Card("The Letter",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"The letter had been in the drawer for fifty years. Tonight, finally, someone opened it.\"</b>", Difficulty.Easy)

            .Card("The Incredibly Good Day",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"It started as the best day of the year — and then it got even better.\"</b>\n\n" +
          "The story must stay genuinely positive all the way through.", Difficulty.Easy)

            .Card("The Dog That Could Talk",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"The dog had always been able to talk. The family had simply never asked him anything important enough before.\"</b>", Difficulty.Easy)

            .Card("The Last Cake",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"There was one slice of cake left. Five people wanted it. The negotiations began.\"</b>", Difficulty.Easy)

            .Card("The Map Under the Floor",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"When they pulled up the old carpet, they found a map drawn on the floorboards underneath. It appeared to show this house — but with an extra room that didn't exist.\"</b>", Difficulty.Easy)

            .Card("The Visitor",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"The visitor arrived exactly as promised — three hundred years late.\"</b>", Difficulty.Easy)

            .Card("The Machine That Remembered Everything",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"The machine in the garage had been there so long no one could remember where it came from. Today it switched itself on.\"</b>", Difficulty.Easy)

            .Card("The Competition",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"The competition was the most ridiculous anyone had ever seen — and somehow every person in the family had entered without telling the others.\"</b>", Difficulty.Easy)

            .Card("The Enormous Sandwich",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"Nobody could explain where the sandwich had come from. It was approximately the size of a door. And it smelled incredible.\"</b>", Difficulty.Easy)

            .Card("The Night the Clocks Stopped",
          "🌟 <b>Build a story together — one sentence each, around the circle.</b>\n\n" +
          "Start here:\n\n<b>\"At exactly midnight, every clock in the house stopped at the same moment. The next morning, nobody could agree on what time it actually was.\"</b>", Difficulty.Easy)
        ...
        // ── CONSTRAINTS ──────────────────────────────────────────────────────
          ...
          "Group picks a story opening between themselves. Begin.", Difficulty.Easy)

            .Card("Every Sentence Ends with a Question",
          ...
          "One person starts the story. Begin.", Difficulty.Easy)

            .Card("Every Sentence, Someone New Arrives",
          ...
          Difficulty.Medium)
            ...
            .Card("No One May Use the Letter E",
          ...
          Difficulty.Hard)
            ...
            .Card("The Story Must Keep Getting Better",
          ...
          Difficulty.Medium)
            ...
            .Card("All Characters Are Household Objects",
        ...
        // ── TWISTS ────────────────────────────────────────────────────────────
            ...
            .Card("It Starts to Rain — Indoors",
           ...
           "Continue the story from here.", Difficulty.Easy)

            .Card("Someone Falls Asleep",
           "⚡ <b>TWIST!</b> Add this to the story you're currently building — or start a new one:\n\n" +
        ...
        // ── SOLO CHALLENGES ──────────────────────────────────────────────────
          ...
          "The story must have a beginning, a middle, and an end.", Difficulty.Easy)

            .Card("The Bedtime Story",
          "⏱ <b>SOLO — 90 seconds</b>\n\n" +
          ...
          Difficulty.Medium)
            ...
            .Card("The Scary Story That Isn't",
          "⏱ <b>SOLO — 90 seconds</b>\n\n" +
