...
public sealed class FamilyDaresMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [FamilyDaresCardBank.PhysicalCategory] = "#66BB6A",
            [FamilyDaresCardBank.PerformanceCategory] = "#FFCA28",
            [FamilyDaresCardBank.MemoryCategory] = "#42A5F5",
            [FamilyDaresCardBank.TeamworkCategory] = "#26C6DA",
        };
...
{
    internal const string PhysicalCategory = "Physical";
    internal const string PerformanceCategory = "Performance";
    internal const string MemoryCategory = "Memory";
    internal const string TeamworkCategory = "Teamwork";

    private const string Deck = "Family Dares";
    ...
    private static IReadOnlyList<ICard> Build() =>
        ...
        // ── EASY ─────────────────────────────────────────────────────────────
            ...
            .Category(PerformanceCategory)
            .Card("Impression of Someone in the Room",
        ...
        // ── EXTREME ───────────────────────────────────────────────────────────
            ...
            .Card("Entire Film in One Minute",
