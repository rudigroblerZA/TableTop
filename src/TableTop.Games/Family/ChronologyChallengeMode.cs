...
public static class ChronologyChallengeCardBank
{
    ...
    private const string Deck = "Chronology Challenge";
    ...
    private static string BodyC(string events, string answer) =>
