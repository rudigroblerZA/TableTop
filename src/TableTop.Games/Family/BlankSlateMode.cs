...
public sealed class BlankSlateMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [BlankSlateCardBank.EverydayCategory] = "#42A5F5",
            [BlankSlateCardBank.SchoolCategory] = "#66BB6A",
            [BlankSlateCardBank.CreaturesCategory] = "#FFA726",
            [BlankSlateCardBank.AbsurdCategory] = "#AB47BC",
        };
...
public static class BlankSlateCardBank
{
    ...
    internal const string SchoolCategory = "School";
