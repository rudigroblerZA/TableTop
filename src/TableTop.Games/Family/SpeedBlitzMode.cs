...
public sealed class SpeedBlitzMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [SpeedBlitzCardBank.NameCategory] = "#42A5F5",
            [SpeedBlitzCardBank.WordsCategory] = "#66BB6A",
            [SpeedBlitzCardBank.TriviaCategory] = "#FFA726",
            [SpeedBlitzCardBank.RiddleCategory] = "#EC407A",
            [SpeedBlitzCardBank.MathCategory] = "#AB47BC",
        };
...
{
    internal const string NameCategory = "Name";
