...
public static class LastOneStandingCardBank
{
    ...
    private const string Deck = "Last One Standing";
    ...
    private static IReadOnlyList<ICard> Build() =>
        CardDeckBuilder.For(Deck)
            ...
            .Card("How You Go Out", Body(RulesCategory,
            ...
            .Card("The Out Players Judge", Body(RulesCategory,
            ...
            .Card("Nobody Goes Out Alone", Body(RulesCategory,
            ...
            .Card("Name One, Quickly", Body(RoundCategory,
            ...
            .Card("Don't Say It", Body(RoundCategory,
            ...
            .Card("Keep A Straight Face", Body(RoundCategory,
            ...
            .Card("Finish The Sentence", Body(RoundCategory,
            ...
            .Card("One Hand Only", Body(RoundCategory,
            ...
            .Card("The Rhyme", Body(RoundCategory,
            ...
            .Card("Twenty Seconds Each", Body(PressureCategory,
            ...
            .Card("Two Things At Once", Body(PressureCategory,
            ...
            .Card("Answer In Questions", Body(PressureCategory,
            ...
            .Card("Nobody Blinks", Body(PressureCategory,
            ...
            .Card("The Impossible Category", Body(PressureCategory,
                "The judges name a category so narrow they doubt anyone can fill it. Everyone must produce one valid " +
                "item. Anyone who can't is out — but if nobody can, the judges lose the card and everyone survives."), Difficulty.Extreme)

            // ── REVIVAL — the eliminated get back in ──────────────────────────────
            .Category(RevivalCategory)
            .Card("One Way Back", Body(RevivalCategory,
            ...
            .Card("Bought Back", Body(RevivalCategory,
            ...
            .Card("Everybody Back", Body(RevivalCategory,
            ...
            .Card("Head To Head", Body(FinalCategory,
            ...
            .Card("Three Rounds, Best Of", Body(FinalCategory,
            ...
            .Card("The Last Question", Body(FinalCategory,
