...
using TableTop.Games.Data;   // MonogamyCardBankExtended
...
///
/// Cards come from the in-code <see cref="MonogamyCardBankExtended"/>. They were
...
public sealed class MonogamyMode : IGameMode, IMonogamyDeckProvider
{
    ...
    /// <inheritdoc />
    public IReadOnlyList<MonogamyCard> GetDeck() => MonogamyCardBankExtended.FullDeck;
