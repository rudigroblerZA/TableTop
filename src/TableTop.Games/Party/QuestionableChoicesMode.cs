...
/// <summary>
/// Built-in card bank for Questionable Choices, authored with
/// <see cref="CardDeckBuilder"/>'s fluent DSL. All content is original. Each
/// card's title is the prompt (truncated by <see cref="Title"/>) and its body
/// is composed by <see cref="Body"/> — the category header, the prompt, and the
/// numbered shortlist.
/// </summary>
public static class QuestionableChoicesCardBank
{
    ...
    private const string Deck = "Questionable Choices";
    ...
    private static IReadOnlyList<ICard> Build() =>
        CardDeckBuilder.For(Deck)
            ...
            // ── MODERN LIFE ──────────────────────────────────────────────────────
            .Category(ModernLifeCategory)
            .Card(Title("My entire personality is now just ______."), Body(ModernLifeCategory, "My entire personality is now just ______.",
            ...
            .Card(Title("Nothing says 'I have my life together' quite like ______."), Body(ModernLifeCategory, "Nothing says 'I have my life together' quite like ______.",
            ...
            .Card(Title("The most stressful part of adulthood is ______."), Body(ModernLifeCategory, "The most stressful part of adulthood is ______.",
            ...
            .Card(Title("I could fix my life tomorrow if it weren't for ______."), Body(ModernLifeCategory, "I could fix my life tomorrow if it weren't for ______.",
            ...
            .Card(Title("There is no feeling worse than ______."), Body(ModernLifeCategory, "There is no feeling worse than ______.",
            ...
            .Card(Title("My phone knows entirely too much about ______."), Body(ModernLifeCategory, "My phone knows entirely too much about ______.",
            ...
            // ── THE OFFICE ───────────────────────────────────────────────────────
            .Category(TheOfficeCategory)
            .Card(Title("This meeting could have been ______."), Body(TheOfficeCategory, "This meeting could have been ______.",
            ...
            .Card(Title("My greatest professional achievement is ______."), Body(TheOfficeCategory, "My greatest professional achievement is ______.",
            ...
            .Card(Title("HR would like a quiet word about ______."), Body(TheOfficeCategory, "HR would like a quiet word about ______.",
            ...
            .Card(Title("The company's new strategy is basically ______."), Body(TheOfficeCategory, "The company's new strategy is basically ______.",
            ...
            .Card(Title("I'd be far more productive if it weren't for ______."), Body(TheOfficeCategory, "I'd be far more productive if it weren't for ______.",
            ...
            .Card(Title("The performance review said I need to work on ______."), Body(TheOfficeCategory, "The performance review said I need to work on ______.",
            ...
            // ── RELATIONSHIPS ────────────────────────────────────────────────────
            .Category(RelationshipsCategory)
            .Card(Title("The fastest way to end a first date is ______."), Body(RelationshipsCategory, "The fastest way to end a first date is ______.",
            ...
            .Card(Title("The true test of a long relationship is ______."), Body(RelationshipsCategory, "The true test of a long relationship is ______.",
            ...
            .Card(Title("The most romantic thing my partner has ever done is ______."), Body(RelationshipsCategory, "The most romantic thing my partner has ever done is ______.",
            ...
            .Card(Title("Our love language is ______."), Body(RelationshipsCategory, "Our love language is ______.",
            ...
            .Card(Title("You know it's serious when they ______."), Body(RelationshipsCategory, "You know it's serious when they ______.",
            ...
            .Card(Title("At 3am, the thought that arrives is ______."), Body(ExistentialCategory, "At 3am, the thought that arrives is ______.",
            ...
            .Card(Title("It turns out the meaning of life was ______ all along."), Body(ExistentialCategory, "It turns out the meaning of life was ______ all along.",
            ...
            .Card(Title("My therapist went quiet when I mentioned ______."), Body(ExistentialCategory, "My therapist went quiet when I mentioned ______.",
            ...
            .Card(Title("The unspoken agreement all adults share is ______."), Body(ExistentialCategory, "The unspoken agreement all adults share is ______.",
            ...
            .Card(Title("The universe sent me a very clear sign when ______."), Body(ExistentialCategory, "The universe sent me a very clear sign when ______.",
            ...
            .Card(Title("The wedding was going perfectly until ______."), Body(ChaosCategory, "The wedding was going perfectly until ______.",
            ...
            .Card(Title("The holiday photos don't show ______."), Body(ChaosCategory, "The holiday photos don't show ______.",
            ...
            .Card(Title("I have never fully recovered from ______."), Body(ChaosCategory, "I have never fully recovered from ______.",
            ...
            .Card(Title("The police report simply read: ______."), Body(ChaosCategory, "The police report simply read: ______.",
            ...
            .Card(Title("The group chat went silent the moment someone mentioned ______."), Body(ChaosCategory, "The group chat went silent the moment someone mentioned ______.",
    ...
    // Title is the prompt, truncated to fit a card header.
