...
public static class QuestionableChoicesCardBank
{
    ...
    [
        // ── MODERN LIFE ──────────────────────────────────────────────────────
        P("Modern Life", "My entire personality is now just ______.",
        ...
        P("Modern Life", "Nothing says 'I have my life together' quite like ______.",
        ...
        P("Modern Life", "The most stressful part of adulthood is ______.",
        ...
        P("Modern Life", "I could fix my life tomorrow if it weren't for ______.",
        ...
        P("Modern Life", "There is no feeling worse than ______.",
        ...
        // ── THE OFFICE ───────────────────────────────────────────────────────
        P("The Office", "This meeting could have been ______.",
        ...
        P("The Office", "My greatest professional achievement is ______.",
        ...
        P("The Office", "HR would like a quiet word about ______.",
        ...
        P("The Office", "The company's new strategy is basically ______.",
        ...
        P("The Office", "I'd be far more productive if it weren't for ______.",
        ...
        // ── RELATIONSHIPS ────────────────────────────────────────────────────
        P("Relationships", "The fastest way to end a first date is ______.",
        ...
        P("Relationships", "The true test of a long relationship is ______.",
        ...
        P("Relationships", "The most romantic thing my partner has ever done is ______.",
        ...
        P("Relationships", "Our love language is ______.",
        ...
        // ── EXISTENTIAL ──────────────────────────────────────────────────────
        P("Existential", "At 3am, the thought that arrives is ______.",
        ...
        P("Existential", "It turns out the meaning of life was ______ all along.",
        ...
        P("Existential", "My therapist went quiet when I mentioned ______.",
        ...
        P("Existential", "The unspoken agreement all adults share is ______.",
        ...
        // ── CHAOS ────────────────────────────────────────────────────────────
        P("Chaos", "The wedding was going perfectly until ______.",
        ...
        P("Chaos", "The holiday photos don't show ______.",
        ...
        P("Chaos", "I have never fully recovered from ______.",
        ...
        P("Chaos", "The police report simply read: ______.",
