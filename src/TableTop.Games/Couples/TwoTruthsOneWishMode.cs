...
public sealed class TwoTruthsOneWishMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [TwoTruthsOneWishCardBank.AboutMeCategory] = "#42A5F5",
            [TwoTruthsOneWishCardBank.AboutUsCategory] = "#66BB6A",
            [TwoTruthsOneWishCardBank.TheFutureCategory] = "#FFCA28",
            [TwoTruthsOneWishCardBank.BigQuestionsCategory] = "#EC407A",
        };
...
{
    internal const string AboutMeCategory = "About Me";
    internal const string AboutUsCategory = "About Us";
