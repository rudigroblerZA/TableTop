...
public sealed class HeatCheckMode : BaseGameModeDefinition, ITableShapeMode
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [HeatCheckCardBank.ConfessionsCategory] = "#EC407A",
            [HeatCheckCardBank.DaresCategory] = "#EF5350",
            [HeatCheckCardBank.ScenesCategory] = "#AB47BC",
            [HeatCheckCardBank.CloserCategory] = "#B71C4A",
        };
...
public static class HeatCheckCardBank
{
    ...
    internal const string DaresCategory = "Dares";
