...
internal static class OutLoudCardBank
{
    ...
    [
        ...
        Card(AdmissionsCategory, "Tell them the exact moment you knew you wanted them. Not the story you usually tell — the actual moment, with the room in it.", Difficulty.Easy,
             "If they've heard this one before, they get to ask for a different moment."),
        Card(AdmissionsCategory, "Name one thing they do when they think you aren't looking, and tell them what it does to you.", Difficulty.Easy,
             "Specificity Rule: name the thing, not the category."),
        Card(AdmissionsCategory, "Describe their hands as if you were describing them to someone who has never seen a pair.", Difficulty.Easy,
             "You may not use the word 'nice'."),
        Card(AdmissionsCategory, "Tell them the last time you were genuinely, uncomplicatedly proud of them — and why.", Difficulty.Easy,
             "This one is allowed to make somebody cry."),
        Card(AdmissionsCategory, "Say what you'd miss first. Not what you'd miss most — what you'd notice missing on day one.", Difficulty.Easy,
             "The small answer is the better answer here."),
        Card(AdmissionsCategory, "Finish this out loud: \"The thing I've never told you I noticed is…\"", Difficulty.Easy,
             "Then let it land. Don't rescue the silence."),
        Card(AdmissionsCategory, "Tell them the physical thing about them you noticed first — and whether it's still the first thing you notice now.", Difficulty.Easy,
             "If the answer changed, say what it changed to."),
        Card(AdmissionsCategory, "Say the compliment you keep meaning to give them and keep forgetting to.", Difficulty.Easy,
             "The forgetting is real. Say it anyway."),
        Card(AdmissionsCategory, "Name a moment from this month you felt lucky to be with them, and say exactly what made it that.", Difficulty.Easy,
             "'Just because' fails the Specificity Rule. There's a real reason — find it."),
        Card(AdmissionsCategory, "Tell them one thing about their voice you could pick out of a crowded room.", Difficulty.Easy,
             "Not the obvious answer. The actual one."),
        Card(AdmissionsCategory, "Describe, out loud, the exact face they make right before they laugh.", Difficulty.Easy,
             "If they make it right now, that's not cheating. That's the card working."),
        Card(AdmissionsCategory, "Tell them something you do differently since you've been with them — and that it's a good thing.", Difficulty.Easy,
             "Small counts. Smaller is often truer."),

        // ── Confessions — a want you've never said aloud ──────────────────────
        Card(ConfessionsCategory, "Say one thing you've wanted for a while and never asked for. Just the sentence. No preamble, no apology, no 'this is silly, but'.", Difficulty.Medium,
             "The preamble is the part you're hiding behind. Cut it."),
        Card(ConfessionsCategory, "Tell them something you think about when they're not in the room.", Difficulty.Medium,
             "You choose how far. You don't get to choose vague."),
        Card(ConfessionsCategory, "Name the compliment you'd most like to be given, in the words you'd most like to hear it in.", Difficulty.Medium,
             "They may use it immediately, or save it. Both are fair."),
        Card(ConfessionsCategory, "Describe the last time you wanted them and said nothing. Where you were, what stopped you.", Difficulty.Medium,
             "'What stopped you' is the half that matters."),
        Card(ConfessionsCategory, "Tell them one thing you'd like more of, and one thing you'd like less of. In that order, and be exact.", Difficulty.Medium,
             "Less-of is harder to say and worth more to hear. Say both."),
        Card(ConfessionsCategory, "Say out loud the thing you'd only ever say with the lights off.", Difficulty.Medium,
             "Lights stay on. That's the card."),
        Card(ConfessionsCategory, "Tell them what you think they're best at, in bed, in words you'd never normally use in a lit room.", Difficulty.Medium,
             "They are allowed to ask you to say it again."),
        Card(ConfessionsCategory, "Tell them a version of a fantasy you've had about them. Soften it as much or as little as you like — but say it.", Difficulty.Medium,
             "A softened true answer beats a vivid invented one. Stay honest."),
        Card(ConfessionsCategory, "Say what you'd ask for if asking cost you nothing — no embarrassment, no chance of being told no.", Difficulty.Medium,
             "The cost is imaginary. Ask like it is."),
        Card(ConfessionsCategory, "Tell them what you think about right before you fall asleep next to them.", Difficulty.Medium,
             "Last night counts. So does most nights."),
        Card(ConfessionsCategory, "Name the thing you've wanted more of lately, and be honest about why you haven't said it yet.", Difficulty.Medium,
             "The why is the harder half of this card. Don't skip it."),
        Card(ConfessionsCategory, "Tell them one thing that surprised you about wanting them — something you didn't expect to want.", Difficulty.Medium,
             "Surprise, not shame. If it comes out apologetic, say it again without the apology."),
        Card(ConfessionsCategory, "Say the line you've rehearsed in your head and never actually said out loud.", Difficulty.Medium,
             "You know the one. Say it now, badly if you have to."),

        // ── Direction — tell them exactly what to do, and keep talking ────────
        Card(DirectionCategory, "Tell them where to put their hands. Be precise enough that they don't have to ask. They do it; you keep talking.", Difficulty.Hard,
             "Running out of words ends the card. Try not to."),
        Card(DirectionCategory, "Give them one instruction, then correct them twice — out loud, kindly, until it's exactly right.", Difficulty.Hard,
             "The correcting is the card. Most people skip straight to grateful."),
        Card(DirectionCategory, "Tell them to slow down. Then keep telling them, in new words, for a full minute.", Difficulty.Hard,
             "New words each time. 'Slower' four times doesn't count."),
        Card(DirectionCategory, "Ask for exactly what you want, in a full sentence, using the words you actually mean rather than the polite ones.", Difficulty.Hard,
             "If you soften it, they get to ask for the unsoftened version."),
        Card(DirectionCategory, "Tell them one thing to do and one thing not to do yet. Hold the 'not yet' as long as you can stand.", Difficulty.Hard,
             "You end the 'not yet' out loud, too. No nodding."),
        Card(DirectionCategory, "Take their hand and narrate where it's going before it gets there.", Difficulty.Hard,
             "Arriving before the sentence does is a pass, not a win."),
        Card(DirectionCategory, "Tell them to stay exactly where they are, and then say why you want them there.", Difficulty.Hard,
             "The why is the whole card."),
        Card(DirectionCategory, "Choose a pace out loud, then hold them to it out loud, every single time it slips.", Difficulty.Hard,
             "Naming the slip is the instruction. Naming it kindly is the skill."),
        Card(DirectionCategory, "Give them one word to listen for. Explain out loud what it will mean before you use it.", Difficulty.Hard,
             "Then use it. Silence after they hear it is not a valid response from either of you."),
        Card(DirectionCategory, "Set one rule for the next few minutes and state it plainly. They may only break it if you say so — out loud.", Difficulty.Hard,
             "You have to actually say so. A look doesn't count."),
        Card(DirectionCategory, "Tell them to ask permission before touching anywhere specific — and answer out loud, every time they ask.", Difficulty.Hard,
             "Silence is not an answer. Say yes or say not yet."),
        Card(DirectionCategory, "Give an instruction, then immediately say out loud why you wanted that and not something else.", Difficulty.Hard,
             "The reason is worth more than the instruction was."),

        // ── Narration — describe it while it happens ──────────────────────────
        Card(NarrationCategory, "Say what you're doing while you do it. Present tense. Don't stop when it gets difficult to talk.", Difficulty.Extreme,
             "The difficulty is the point. Whisper if you must — but keep going."),
        Card(NarrationCategory, "Describe what you can see, in detail, without stopping for as long as they can take it.", Difficulty.Extreme,
             "They call time, not you."),
        Card(NarrationCategory, "Tell them what you're about to do, in full, and then make them wait through the whole description before you do any of it.", Difficulty.Extreme,
             "No skipping ahead. The waiting is the card."),
        Card(NarrationCategory, "Say what you want to happen next — not what's happening, what's next. Keep saying it until it does.", Difficulty.Extreme,
             "Future tense only. It's harder than it sounds."),
        Card(NarrationCategory, "Describe them to themselves, right now, exactly as you're seeing them.", Difficulty.Extreme,
             "Eye contact if you can manage it. This one is worth managing it for."),
        Card(NarrationCategory, "Ask them to tell you what they want, and don't do anything at all until they've said it in a full sentence.", Difficulty.Extreme,
             "You wait. However long it takes. That's your half of this card."),
        Card(NarrationCategory, "Narrate what you're feeling, not just what you're doing — name the actual physical sensation as it happens.", Difficulty.Extreme,
             "'Good' is not a sensation. Find the real word."),
        Card(NarrationCategory, "Describe out loud exactly what changes in their face as things go on.", Difficulty.Extreme,
             "You have to actually be watching for this one."),
        Card(NarrationCategory, "Say what sound you want to hear next, before it happens — then say out loud when you get it.", Difficulty.Extreme,
             "Both halves are required. Asking without confirming is only half the card."),
        Card(NarrationCategory, "Narrate exactly where your attention is, moment to moment, without going quiet.", Difficulty.Extreme,
             "Quiet ends the card. Keep talking, even in fragments."),
        Card(NarrationCategory, "Describe out loud what you plan to do in the next thirty seconds, in full — then do exactly what you said.", Difficulty.Extreme,
             "No improvising once you've said it. The sentence is the contract."),
        Card(NarrationCategory, "Say out loud the moment you stop being able to talk — and try to keep going ten more seconds past that.", Difficulty.Extreme,
        ...
        Card(CloserCategory, "Last card. Tell them one thing from tonight you want to happen again — and say when.", Difficulty.Easy,
             "Then put the deck down. It has run out of questions and you clearly haven't."),
        Card(CloserCategory, "Last card. Say one thing tonight taught you about each other that you didn't know this morning.", Difficulty.Easy,
             "Learning something counts even if it's small. Especially if it's small."),
        Card(CloserCategory, "Last card. Name the version of tonight you'd want to repeat, word for word if you could — then decide together when.", Difficulty.Easy,
