...
public sealed class CartographersMode : BaseGameModeDefinition, ITableShapeMode
{
    ...
    /// </summary>
    public override IReadOnlyList<string> CategoriesPinnedToStart => [CartographersCardBank.SurveyCategory];

    /// <inheritdoc cref="CategoriesPinnedToStart" />
    public override IReadOnlyList<string> CategoriesPinnedToEnd => [CartographersCardBank.TerraIncognitaCategory];

    /// <summary>Category → hex colour map used by UIs to tint card chrome.</summary>
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        new Dictionary<string, string>
        {
            [CartographersCardBank.SurveyCategory] = "#8D6E63",
            [CartographersCardBank.TerrainCategory] = "#66BB6A",
            [CartographersCardBank.SettlementCategory] = "#FFA726",
            [CartographersCardBank.LegendCategory] = "#42A5F5",
            [CartographersCardBank.TerraIncognitaCategory] = "#7E57C2",
        };
...
{
    internal const string SurveyCategory = "Survey";
    internal const string TerrainCategory = "Terrain";
    internal const string SettlementCategory = "Settlement";
