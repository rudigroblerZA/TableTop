...
public static class InYourShoesCardBank
{
    ...
    [
        ...
        S(EverydayCategory, "The Last Slice",
          ...
          Difficulty.Easy),
        S(EverydayCategory, "Free Saturday",
          ...
          Difficulty.Easy),
        S(EverydayCategory, "The Grocery Run",
          ...
          Difficulty.Easy),
        S(EverydayCategory, "Road Trip Radio",
          ...
          Difficulty.Easy),
        S(EverydayCategory, "The Ideal Night In",
        ...
        S(EverydayCategory, "Pet Peeve",
          ...
          Difficulty.Medium),
        S(EverydayCategory, "Comfort Order",
          ...
          Difficulty.Easy),
        S(EverydayCategory, "The Group Chat",
        ...
        S(InnerCategory, "The Proud Moment",
          ...
          Difficulty.Medium),
        S(InnerCategory, "The Quiet Worry",
          ...
          Difficulty.Hard),
        S(InnerCategory, "What They'd Change",
        ...
        S(InnerCategory, "The Recharge",
          ...
          Difficulty.Medium),
        S(InnerCategory, "The Compliment That Lands",
        ...
        S(InnerCategory, "Five Years",
          ...
          Difficulty.Hard),
        S(InnerCategory, "The Childhood Thread",
          ...
          Difficulty.Extreme),
        S(InnerCategory, "The Unspoken No",
        ...
        S(UsCategory, "Their Favourite 'Us'",
        ...
        S(UsCategory, "The Thing I Do",
          ...
          Difficulty.Hard),
        S(UsCategory, "When They Felt Closest",
          ...
          Difficulty.Hard),
        S(UsCategory, "What They'd Protect",
        ...
        S(UsCategory, "The Reassurance",
          ...
          Difficulty.Extreme),
        S(UsCategory, "How They'd Describe Us",
