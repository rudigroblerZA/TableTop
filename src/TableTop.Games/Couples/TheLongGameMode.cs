...
public sealed class TheLongGameMode : BaseGameModeDefinition, ITableShapeMode
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [TheLongGameCardBank.NoticingCategory] = "#66BB6A",
            [TheLongGameCardBank.GratitudeCategory] = "#FFCA28",
            [TheLongGameCardBank.WeatheredCategory] = "#78909C",
            [TheLongGameCardBank.VowsCategory] = "#EC407A",
        };
...
{
    internal const string NoticingCategory = "Noticing";
    internal const string GratitudeCategory = "Gratitude";
