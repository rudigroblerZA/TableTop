...
public static class BetweenTheTwoOfYouCardBank
{
    ...
    private const string Deck = "Between the Two of You";
    ...
    private static IReadOnlyList<ICard> Build()
    {
        ...
        return CardDeckBuilder.For(Deck)
            ...
            .Category(LeadFollowCategory)
            .Card("Who Sets the Pace",
              ...
              "D) Fully mutual — neither leads; you move together.",
                Difficulty.Easy, restriction: couples)
            .Card("Being Told vs Asking",
              ...
              "D) Reading each other wordlessly, no one 'in charge'.",
                Difficulty.Medium, restriction: couples)
            .Card("Where You Feel Most Free",
            ...
            .Category(GiveReceiveCategory)
            .Card("Where Your Attention Goes",
            ...
            .Category(PlanSparkCategory)
            .Card("Anticipation vs Surprise",
            ...
            .Category(WordsTouchCategory)
            .Card("How Desire Reaches You",
            ...
            .Card("The Suggestion",
              ...
              "D) 'Let me think.' You want time before you decide.",
                Difficulty.Medium, restriction: couples)
            .Card("Somewhere That Isn't Here",
