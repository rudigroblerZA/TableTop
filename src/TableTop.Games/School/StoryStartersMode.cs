...
public sealed class StoryStartersMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [StoryStartersCardBank.StarterCategory] = "#42A5F5",
            [StoryStartersCardBank.ConstraintCategory] = "#FFCA28",
            [StoryStartersCardBank.TwistCategory] = "#EC407A",
            [StoryStartersCardBank.ChallengeCategory] = "#AB47BC",
        };
...
{
    internal const string StarterCategory = "Starter";
    internal const string ConstraintCategory = "Constraint";
