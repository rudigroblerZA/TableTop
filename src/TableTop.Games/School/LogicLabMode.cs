...
public static class LogicLabCardBank
{
    ...
    [
        ...
        P(RiddlesCategory, "Always Ahead",
          ...
          Difficulty.Easy),
        P(RiddlesCategory, "The Hole Truth",
          ...
          Difficulty.Easy),
        P(RiddlesCategory, "Full of Keys",
          ...
          Difficulty.Medium),
        P(RiddlesCategory, "The Silent Speaker",
          ...
          Difficulty.Medium),
        P(RiddlesCategory, "The Honest Thief",
        ...
        P(DeductionCategory, "Three Pets",
          ...
          Difficulty.Medium),
        P(DeductionCategory, "Podium Sisters",
          ...
          Difficulty.Medium),
        P(DeductionCategory, "The Lunch Order",
          ...
          Difficulty.Hard),
        P(DeductionCategory, "The Bookshelf",
          ...
          Difficulty.Hard),
        P(DeductionCategory, "The Coin Pouches",
          ...
          Difficulty.Hard),
        P(DeductionCategory, "Born Together, Not Twins",
        ...
        P(TruthLiesCategory, "The Self-Accuser",
          ...
          Difficulty.Hard),
        P(TruthLiesCategory, "The Fork in the Road",
          ...
          Difficulty.Extreme),
        P(TruthLiesCategory, "The Impossible Pair",
          ...
          Difficulty.Extreme),
        P(TruthLiesCategory, "The Cake Culprit",
          ...
          Difficulty.Hard),
        P(TruthLiesCategory, "One Door, Two Guards",
        ...
        P(AssumptionsCategory, "The Doctor's Brother",
          ...
          Difficulty.Medium),
        P(AssumptionsCategory, "Thirty Pence",
          ...
          Difficulty.Medium),
        P(AssumptionsCategory, "The Hotel Walk",
          ...
          Difficulty.Medium),
        P(AssumptionsCategory, "The Unlit Room",
          ...
          Difficulty.Easy),
        P(AssumptionsCategory, "Half Full",
          ...
          Difficulty.Hard),
        P(AssumptionsCategory, "The Elevator Ride",
          ...
          Difficulty.Hard),
        P(AssumptionsCategory, "The Grateful Customer",
