...
public static class EstimationStationCardBank
{
    ...
    [
        // ── MEASUREMENT ───────────────────────────────────────────────────────
        E(MeasurementCategory, "How many litres of water fill a standard bathtub?",
          "About 150 litres (a bucket is ~10 L — picture 15 buckets).", Difficulty.Easy),
        E(MeasurementCategory, "How tall is an adult giraffe, in metres?",
          "About 5 metres — roughly a two-storey house.", Difficulty.Easy),
        E(MeasurementCategory, "How many centimetres long is a standard school ruler?",
          "30 cm. (If someone gets this wrong, discuss.)", Difficulty.Easy),
        E(MeasurementCategory, "How much does an adult elephant weigh, in kilograms?",
          "About 5,000 kg (5 tonnes) for an African elephant.", Difficulty.Medium),
        E(MeasurementCategory, "How long is a football (soccer) pitch, in metres?",
          "About 105 metres, goal line to goal line.", Difficulty.Medium),
        E(MeasurementCategory, "How many millilitres are in a typical can of fizzy drink?",
          "330 ml in most of the world; 355 ml in North America.", Difficulty.Easy),
        E(MeasurementCategory, "How heavy is a typical cloud (a fair-weather cumulus), in kilograms?",
          "Around 500,000 kg — the weight of about 100 elephants, floating.", Difficulty.Hard),
        E(MeasurementCategory, "How deep is the deepest point of the ocean, in metres?",
          "About 11,000 m (the Mariana Trench). Everest would sink without a trace.", Difficulty.Medium),

        // ── NATURE ────────────────────────────────────────────────────────────
        E(NatureCategory, "How many legs does a typical millipede actually have?",
          "Most have 100–400. The record holder has 1,306 — but 'milli' (1,000) is marketing.", Difficulty.Medium),
        E(NatureCategory, "How many years can a giant tortoise live?",
          "Over 150 years. Some alive today hatched in the 1800s.", Difficulty.Easy),
        E(NatureCategory, "How many bees live in a typical honeybee hive in summer?",
          "About 50,000.", Difficulty.Medium),
        E(NatureCategory, "How fast can a cheetah run at top speed, in km/h?",
          "About 110 km/h — motorway speed, on paws.", Difficulty.Easy),
        E(NatureCategory, "How many hearts does an octopus have?",
          "Three. Two pump blood to the gills, one to the body.", Difficulty.Easy),
        E(NatureCategory, "How tall is the tallest tree on Earth, in metres?",
          "About 116 m (a coast redwood named Hyperion) — taller than a 30-storey building.", Difficulty.Medium),
        E(NatureCategory, "How many ants are estimated to live on Earth, in trillions?",
          "About 20,000 trillion (20 quadrillion). Roughly 2.5 million ants per human.", Difficulty.Hard),
        E(NatureCategory, "How long can a snail sleep, in years?",
          "Up to 3 years in one stretch, waiting for wet weather.", Difficulty.Hard),

        // ── EVERYDAY ──────────────────────────────────────────────────────────
        E(EverydayCategory, "How many times does a person blink in one day?",
          "About 15,000–20,000 times.", Difficulty.Medium),
        E(EverydayCategory, "How many sheets of paper are in a standard ream?",
          "500 sheets.", Difficulty.Easy),
        E(EverydayCategory, "How many steps does an average person take in a day?",
          "About 4,000–5,000 for most people (the famous 10,000 was a marketing slogan).", Difficulty.Easy),
        E(EverydayCategory, "How many words does an average person speak per day?",
          "Roughly 16,000 — men and women almost identical, despite the myth.", Difficulty.Medium),
        E(EverydayCategory, "How many hours will the average person spend asleep by age 75?",
          "About 220,000 hours — roughly 25 YEARS of sleeping.", Difficulty.Hard),
        E(EverydayCategory, "How many grapes does it take to make one bottle of wine?",
          "About 600–800 grapes.", Difficulty.Hard),
        E(EverydayCategory, "How many keys are on a full-size piano?",
          "88 — 52 white, 36 black.", Difficulty.Easy),
        E(EverydayCategory, "How many litres of milk does a dairy cow produce per day?",
          "About 25–30 litres.", Difficulty.Medium),

        // ── SPACE ─────────────────────────────────────────────────────────────
        E(SpaceCategory, "How long does light from the Sun take to reach Earth, in minutes?",
          "About 8 minutes 20 seconds.", Difficulty.Easy),
        E(SpaceCategory, "How many Earths would fit inside the Sun?",
          "About 1.3 million.", Difficulty.Medium),
        E(SpaceCategory, "How far away is the Moon, in kilometres?",
          "About 384,000 km — you could line up all the other planets in the gap.", Difficulty.Medium),
        E(SpaceCategory, "How many days does Mercury take to orbit the Sun?",
          "88 days. A Mercury 'year' is shorter than a school term.", Difficulty.Hard),
        E(SpaceCategory, "How fast is the International Space Station moving, in km/h?",
          "About 28,000 km/h — it laps Earth every 90 minutes.", Difficulty.Hard),
        E(SpaceCategory, "What temperature is the surface of the Sun, in degrees Celsius?",
          "About 5,500 °C. (The core is 15 million.)", Difficulty.Medium),

        // ── BODY ──────────────────────────────────────────────────────────────
        E(BodyCategory, "How many bones does an adult human have?",
          "206. Babies start with about 300 — many fuse as they grow.", Difficulty.Easy),
        E(BodyCategory, "How many times does your heart beat in one day?",
          "About 100,000 times.", Difficulty.Medium),
        E(BodyCategory, "How long are all the blood vessels in your body if laid end to end, in kilometres?",
          "Roughly 100,000 km — two and a half times around the Earth.", Difficulty.Hard),
        E(BodyCategory, "How many litres of saliva does a person produce in a year?",
          "About 400–500 litres. You're welcome.", Difficulty.Hard),
        E(BodyCategory, "How many muscles does it take to smile?",
          "About 12 — and around 11 to frown, so the old saying is backwards.", Difficulty.Medium),
        E(BodyCategory, "How fast does a sneeze travel, in km/h?",
          "About 60–70 km/h (the '160 km/h' figure is a myth, but it's still fast).", Difficulty.Medium),

        // ── SPEED & TIME ──────────────────────────────────────────────────────
        E(SpeedTimeCategory, "How many seconds are in one day?",
          "86,400.", Difficulty.Easy),
        E(SpeedTimeCategory, "How long would it take to walk around the Earth's equator, walking 8 hours a day?",
          "About 3 years (40,000 km at ~5 km/h, 8 h/day ≈ 1,000 days) — ignoring the oceans.", Difficulty.Hard),
        E(SpeedTimeCategory, "How fast does sound travel through air, in metres per second?",
          "About 343 m/s. Count seconds between lightning and thunder, divide by 3, get kilometres.", Difficulty.Medium),
        E(SpeedTimeCategory, "How many minutes are in a week?",
          "10,080.", Difficulty.Medium),
        E(SpeedTimeCategory, "How old is the Earth, in billions of years?",
          "About 4.5 billion years.", Difficulty.Easy),
        E(SpeedTimeCategory, "If you counted one number per second, nonstop, how many DAYS to reach a million?",
          "About 11.5 days. (A billion would take 32 years.)", Difficulty.Hard),

        // ── EXPANSION: WEIRD BUT TRUE ─────────────────────────────────────────
        E(BodyCategory, "How many skin cells do you shed per day?",
          "Around 500 million. A lot of household dust used to be you.", Difficulty.Hard),
        E(BodyCategory, "How many dreams does a person have per night?",
          "About 4–6. You forget nearly all of them within minutes.", Difficulty.Medium),
        E(BodyCategory, "How many times will you laugh today, on average?",
          "Adults: about 15–20 times. Children: closer to 300. Discuss.", Difficulty.Medium),
        E(NatureCategory, "How many times does a hummingbird's heart beat per minute?",
          "Up to 1,200 while flying.", Difficulty.Hard),
        E(NatureCategory, "How loud is a blue whale's call, in decibels?",
          "About 188 dB — louder than a jet engine; audible across hundreds of kilometres of ocean.", Difficulty.Hard),
        E(NatureCategory, "How many eggs does a queen bee lay per day in summer?",
          "Up to 2,000 — more than her own body weight.", Difficulty.Medium),
        E(EverydayCategory, "How many times does the average person check their phone per day?",
          "Around 100–150 times. Yes, including during this game.", Difficulty.Easy),
        E(EverydayCategory, "How many years of their life does the average person spend queueing?",
          "Roughly 6 months to a year, depending on country. Feels longer.", Difficulty.Hard),
        E(EverydayCategory, "How many words are in the longest official place name in the world?",
          "The Welsh village name has 58 letters; the Māori hill name has 85. One word each.", Difficulty.Extreme),
        E(SpaceCategory, "How many pieces of space junk larger than 10 cm orbit Earth?",
          "Around 35,000 tracked pieces — humanity litters everywhere it goes.", Difficulty.Hard),
        E(SpaceCategory, "How long is one day on Venus, in Earth days?",
          "About 243 Earth days — longer than its year (225). Venus is not okay.", Difficulty.Extreme),
        E(MeasurementCategory, "How much does the internet weigh (all its moving electrons), roughly in grams?",
