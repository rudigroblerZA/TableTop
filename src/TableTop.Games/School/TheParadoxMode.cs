...
public sealed class TheParadoxMode : BaseGameModeDefinition
{
    ...
    public override IReadOnlyDictionary<string, string> CategoryColours =>
        ...
        {
            [TheParadoxCardBank.LogicCategory] = "#42A5F5",
            [TheParadoxCardBank.PhilosophyCategory] = "#AB47BC",
            [TheParadoxCardBank.PhysicsCategory] = "#FFA726",
            [TheParadoxCardBank.RiddleCategory] = "#FFCA28",
            [TheParadoxCardBank.ImpossibleCategory] = "#EF5350",
        };
...
public static class TheParadoxCardBank
{
    ...
    internal const string PhysicsCategory = "Physics";
