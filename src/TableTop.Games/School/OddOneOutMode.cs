...
public static class OddOneOutCardBank
{
    ...
    private const string Deck = "Odd One Out";
    ...
    private static IReadOnlyList<ICard> Build() =>
        CardDeckBuilder.For(Deck)
            ...
            .Card(FoodCategory, Body("Rice", "Wheat", "Corn", "Quinoa",
                "Quinoa — not a grass. It's a seed pretending, botanically closer to spinach."), Difficulty.Hard)

            // ── WORLD ────────────────────────────────────────────────────────────
            .Category(WorldCategory)
            .Card(WorldCategory, Body("Brazil", "Mexico", "Egypt", "Sudan",
            ...
            .Card(WorldCategory, Body("Venice", "Amsterdam", "Bangkok", "Madrid",
                "Madrid — no canals. The other three all claim the title 'Venice of…' something."), Difficulty.Easy)
            .Card(WorldCategory, Body("Japan", "New Zealand", "Iceland", "Mongolia",
                "Mongolia — the only landlocked one; the rest are island nations."), Difficulty.Easy)
            .Card(WorldCategory, Body("Russia", "Canada", "China", "Australia",
            ...
            .Card(WordsCategory, Body("Whisper", "Buzz", "Sizzle", "Shout",
                "Shout — the only one that isn't onomatopoeia; it describes volume, not sound."), Difficulty.Medium)
            .Card(WordsCategory, Body("Bookkeeper", "Committee", "Balloon", "Assess",
            ...
            .Card(WordsCategory, Body("Quiz", "Jazz", "Fizz", "Quit",
            ...
            .Card(ScienceCategory, Body("Diamond", "Graphite", "Charcoal", "Quartz",
                "Quartz — the only one that isn't carbon. The other three are the same element in wildly different moods."), Difficulty.Hard)

            .Build();

    private static string Body(string i1, string i2, string i3, string i4, string reveal) =>
