...
public static class PunctuationWarsCardBank
{
    ...
    private const string Deck = "Punctuation Wars";
    ...
    private static IReadOnlyList<ICard> Build() =>
        CardDeckBuilder.For(Deck)
            ...
            .Category(ApostropheCategory)
            .Card("its vs it's",
                "✏️  <b>Fix the error:</b>\n\n" +
                "<b>\"The dog wagged it's tail and ran to it's owner.\"</b>\n\n" +
                "1️⃣  Find the two errors.\n" +
                "2️⃣  Explain the rule: when does <b>its</b> have an apostrophe, and when doesn't it?", Difficulty.Easy)
            .Card("Possession singular",
                ...
                "2️⃣  How many apostrophes does this sentence need?", Difficulty.Easy)
            .Card("Possession plural",
                ...
                "2️⃣  Now write two sentences — one with a singular possessive, one with a plural possessive.", Difficulty.Easy)
            .Card("Contraction or possession?",
                ...
                "2️⃣  For each: is it a <b>contraction</b> or a <b>possessive</b>?", Difficulty.Easy)
            .Category(CommaCategory)
            .Card("Comma in a list",
                "✏️  <b>Add commas:</b>\n\n" +
                "<b>\"She packed a torch a sleeping bag three cereal bars a map and a compass.\"</b>\n\n" +
                "1️⃣  How many commas does this sentence need?\n" +
                "2️⃣  Should there be a comma before 'and'? Explain both sides.", Difficulty.Easy)
            .Card("Comma splice",
                "✏️  <b>Fix the error:</b>\n\n" +
                "<b>\"It was raining, we stayed inside, nobody was happy.\"</b>\n\n" +
                "1️⃣  What is a comma splice?\n" +
                "2️⃣  Fix this sentence in <b>two different ways</b>.", Difficulty.Easy)
            .Category(SpeechMarksCategory)
            .Card("Direct speech basics",
                ...
                "2️⃣  How many punctuation marks did you add in total?", Difficulty.Easy)
            .Category(SentenceCategory)
            .Card("Capital letters in sentences",
                ...
                "2️⃣  Give the rule for each category of word you capitalised.", Difficulty.Easy)
            .Card("Full stop, question mark, or exclamation?",
                ...
                "2️⃣  When should you NOT use an exclamation mark?", Difficulty.Easy)

            // ── MEDIUM: multiple marks, subtler rules ─────────────────────────────
            .Category(CommaCategory)
            .Card("Comma with subordinate clause",
                ...
                "2️⃣  Write one sentence with the clause at the start and one with it at the end.", Difficulty.Medium)
            .Card("Embedded clause commas",
                "✏️  <b>Add punctuation:</b>\n\n" +
                ...
                "2️⃣  What is the embedded clause? Could you remove it and still have a complete sentence?", Difficulty.Medium)
            .Category(ColonSemicolonCategory)
            .Card("Colon to introduce",
                ...
                "3️⃣  Write your own sentence using a colon to introduce a list.", Difficulty.Medium)
            .Card("Semicolon rule",
                ...
                "3️⃣  Could you replace it with 'and'? What would change?", Difficulty.Medium)
            .Category(SpeechMarksCategory)
            .Card("Speech punctuation full",
                ...
                "3️⃣  Why does 'it' not start with a capital letter?", Difficulty.Medium)
            .Card("New speaker, new line",
                ...
                "2️⃣  Find and fix the punctuation error in Finn's second line of speech.", Difficulty.Medium)
            .Category(MixedCategory)
            .Card("Parenthetical commas vs brackets vs dashes",
                ...
                "1️⃣  Which version feels most formal? Which is most dramatic?", Difficulty.Medium)

            // ── HARD: complex sentences, subtle errors, advanced rules ────────────
            .Category(ApostropheCategory)
            .Card("Apostrophe with irregular plurals",
                ...
                "2️⃣  Fix each sentence. Where exactly does the apostrophe go in each case?", Difficulty.Hard)
            .Category(ColonSemicolonCategory)
            .Card("Colon vs semicolon decision",
                ...
                "1️⃣  Colon or semicolon for each? State your reason.", Difficulty.Hard)
            .Category(CommaCategory)
            .Card("The Oxford comma debate",
                ...
                "3️⃣  Write two sentences where the Oxford comma changes the meaning completely.", Difficulty.Hard)
            .Category(MixedCategory)
            .Card("Complex sentence with multiple clauses",
                ...
                "2️⃣  How many commas did you add? Explain the purpose of each one.", Difficulty.Hard)
            .Card("Dash vs hyphen vs ellipsis",
                ...
                "2️⃣  Write one original sentence that uses all three correctly.", Difficulty.Hard)

            // ── EXTREME: full-passage punctuation, analysis ───────────────────────
            .Card("Unpunctuated passage",
                ...
                "2️⃣  How many punctuation marks did you add? List the types.", Difficulty.Extreme)
            .Card("Find every error",
                ...
                "3️⃣  Write the passage correctly.", Difficulty.Extreme)
