...
public static class ReadingComprehensionCardBank
{
    ...
    private const string Deck = "Reading Comprehension";
    ...
    private static IReadOnlyList<ICard> Build() =>
        ...
        // ── Easy: literal comprehension ───────────────────────────────────────
          ...
          "<b>Question:</b> What evidence does the passage give that the oak tree has survived difficult conditions?", Difficulty.Easy)

            .Card("The Market at Dawn",
          ...
          "<b>Question:</b> List three details the passage gives about what the market was like at dawn.", Difficulty.Easy)

            .Card("Ice in the Antarctic",
          ...
          "<b>Question:</b> According to the passage, why do scientists study Antarctic ice cores?", Difficulty.Easy)

            .Card("A Dog's Sense of Smell",
          ...
          "<b>Question:</b> Name two practical uses of a dog's sense of smell mentioned in the passage.", Difficulty.Easy)

            .Card("The Invention of the Printing Press",
          ...
          "<b>Question:</b> Why were books rare and expensive before Gutenberg's invention?", Difficulty.Easy)

        // ── Medium: inferential questions ─────────────────────────────────────

            .Category(InferentialCategory)
            .Card("The Empty Chair",
          ...
          "What does her behaviour suggest about how she feels?", Difficulty.Medium)

            .Card("The Last Forest",
          ...
          "What does the passage suggest they might be feeling?", Difficulty.Medium)
          ...
          "Why might the author have chosen not to include any dialogue?", Difficulty.Medium)

            .Card("The Tide Comes In",
          ...
          "What might the sea represent?", Difficulty.Medium)

            .Card("Climate Migration",
          ...
          "The passage never states this directly — what can you infer?", Difficulty.Medium)
        ...
        // ── Medium: vocabulary in context ─────────────────────────────────────
          ...
          "What clues in the passage help you work out the meaning?", Difficulty.Medium)
          ...
          "<b>Question:</b> What does 'precocious' mean? How does the passage help you understand it?", Difficulty.Medium)
          ...
          "How does the word 'drama' in the same sentence help you?", Difficulty.Medium)
        ...
        // ── Hard: author's purpose and technique ──────────────────────────────
          ...
          "What does Mrs Johnson's reaction suggest about the author's view of persuasive language?", Difficulty.Hard)

            .Card("The Warning Sign",
          ...
          "rather than stating a conclusion? What effect does this have on the reader?", Difficulty.Hard)
          ...
          "What different emotions does each create in the reader, and how?", Difficulty.Hard)
        ...
        // ── Extreme: complex literary analysis ────────────────────────────────
          ...
          "Discuss at least two possible interpretations, referring closely to the language of the passage.", Difficulty.Extreme)

            .Category(AuthorCategory)
            .Card("The Unreliable Garden",
          ...
          "How might this be relevant in a wider literary context?", Difficulty.Extreme)
          ...
          "How does the final detail (placing it to see every morning) add to the passage's meaning?", Difficulty.Extreme)
            .Build();
}